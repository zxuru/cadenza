...
| Payload | How |
| --- | --- |
| The app | `assets/app.zip`: every module compiled (`main.pyc`, `engine.pyc`, `spotify.pyc`, `pending.pyc`, `transcode.pyc`, `metadata.pyc`, `bundle.pyc`, `i18n.pyc`, `settings.pyc`), plus `assets/` and `locales/` |
